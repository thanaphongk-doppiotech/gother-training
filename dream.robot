...
*** Variables ***
&{student_geng}    name=Geng    score=49
&{student_dapper}    name=Dapper    score=85
&{student_dream}    name=Dream    score=79
&{student_fon}    name=Fon    score=58
&{student_pat}    name=Pat    score=64
@{students}    &{student_geng}    &{student_dapper}    &{student_dream}    &{student_fon}    &{student_pat}
